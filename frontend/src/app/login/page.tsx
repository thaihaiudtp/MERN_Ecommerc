            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="email" value={form.email} onChange={handleInputChange} type="text" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
