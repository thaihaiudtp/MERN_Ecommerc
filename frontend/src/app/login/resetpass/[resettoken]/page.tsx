...
import ChangePass from "@/apis/user/changepass"
export default function resetPass(){
    ...
    async function handleSubmit(e: any){
        ...
        await ChangePass(password, resettoken)
        router.push("/login")
    }
    return(
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative flex items-center">
                    <input value={password} onChange={(e)=>setPassword(e.target.value)} name="password" type="text" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
