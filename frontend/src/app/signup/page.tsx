...
export default function Signup(){
    ...
    const handleFormSubmit = async (e:React.FormEvent)=>{
        ...
        try {
            ...
            console.log(data)
            if(data.success){
                setSuccessmes("Đăng ký thành công")
                router.push('/login')
            } else {
    ...
    return(
        ...
        <div className="grid md:grid-cols-2 items-center gap-8 h-full">
          ...
          <div className="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto">
            <form className="max-w-lg w-full mx-auto" onSubmit={handleFormSubmit}>
              <div className="mb-12">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="name" type="text" required className="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter name" value={form.name} onChange={handleInputChange} />
              ...
              <div className="mt-8">
                ...
                <div className="relative flex items-center">
                  <input name="email" value={form.email} onChange={handleInputChange} type="text" required className="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter email" />
              ...
              <div className="mt-8">
                ...
                <div className="relative flex items-center">
                  <input name="password" value={form.password} onChange={handleInputChange} type="password" required className="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter password" />
              ...
              {error && <h1 className="text-red-500">{error}</h1>} {/* Hiển thị thông báo lỗi */}
