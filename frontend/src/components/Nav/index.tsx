export default function Sidebar(){
    return (
        <nav className="bg-neutral-700 shadow-lg h-screen fixed top-0 left-0 min-w-[180px] py-6 px-4 font-[sans-serif] overflow-auto mt-9 z-10">
            <ul className="mt-12">
                <li>
                    <a href="#" className="text-white hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
            ...
            <div className="mt-6">
                <h6 className="text-blue-500 text-sm font-bold px-4">Information</h6>
                <ul className="mt-3">
                    <li>
                        <a href="#" className="text-white hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"viewBox="0 0 512 512">
                    ...
                    <li>
                        <a href="#"
                        className="text-white hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
